...
@ControllerAdvice
@RestController
public class CustamizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ExceptionResponse> handleUserNotFoundExceptions(
